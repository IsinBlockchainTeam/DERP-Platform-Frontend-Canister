                ...
                {store ?
                    <>
                        <div className={'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-10'}>
                            <MenuAccessCard destinationUrl={`/merchant/${merchantIdNumber}/stores/${store.id}/balance`}
                                            title={"Bilancio"}
                                            text={"Visualizza il bilancio finanziario del negozio, comprese entrate, uscite e saldo attuale."}
                                            buttonText={"Vai al bilancio"}
