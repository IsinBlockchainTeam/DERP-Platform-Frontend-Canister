    ...
    return <>
        <div className="flex flex-col grow mr-3">
            <input type="text" className="input input-bordered mb-3" placeholder={t('tableLabelPlaceholder')} value={label} onChange={e => onChangeLabel(e.target.value)} />
            {
                ...
                <div>
                    <input type="text" className="input input-bordered mb-3" placeholder={t('posUsernamePlaceholder')} value={username} onChange={e => onChangeUsername(e.target.value)} />
                    <input type="password" className="input input-bordered mb-3" placeholder={t('posPasswordPlaceholder')} value={password} onChange={e => onChangePassword(e.target.value)} />
                </div>
            }
        </div>
